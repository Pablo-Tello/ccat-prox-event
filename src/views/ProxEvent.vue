<template>
    <v-container class="prox_eventos">
        <!-- Mostrar Eventos -->
        <div class="prox_eventos-mosaicos">
            ...
            v-show="indice === index">
                ...
                v-for="(evento, index2) of grupoEvento" :key="evento.id">
                    ...
                    <button class="btn btn-success evento_btn_inscribir">Inscripción</button> <!-- B4 -->
                </div>
            </div>
